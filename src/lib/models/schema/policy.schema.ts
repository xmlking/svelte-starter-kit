...
export const policyCreateBaseSchema = policyBaseSchema.extend({
	...
	subjectType: z.enum(['subject_type_user', 'subject_type_group', 'subject_type_device', 'subject_type_service_account']),
...
export const policySearchSchema = z.object({
	...
	subjectType: z.enum(['subject_type_user', 'subject_type_group', 'subject_type_device', 'subject_type_service_account']).optional(),
